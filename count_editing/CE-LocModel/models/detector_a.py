...
__all__ = ["BoxDiT", "CELocDetectorA", "build_model_a"]
...
class CELocDetectorA(nn.Module):
...
def build_model_a(cfg, dropout=None):
    """Config -> CELocDetectorA. MỘT chỗ dựng mô hình duy nhất cho mọi điểm vào.
