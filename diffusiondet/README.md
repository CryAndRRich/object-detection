...
[`docs/old/ROUND_1_ARCHIVE.md (phần 06)`](../../docs/old/ROUND_1_ARCHIVE.md).
...
| File | Vai trò |
|---|---|
| `minicoco_model_final.pth`, `voc_model_final.pth`, `crowdhuman_model_final.pth` | 3 checkpoint tự train, số liệu trong `docs/old/ROUND_1_ARCHIVE.md (phần 06)` |
...
hưởng tới các số đã đo trong `docs/old/ROUND_1_ARCHIVE.md (phần 06)` (đó là hành vi thật của model, đã đo đúng) — chỉ dễ
...
# 2. CỬA CHẶN bắt buộc — nhìn bằng mắt trước khi train (bài học docs/old/ROUND_1_ARCHIVE.md (phần 02)
...
`docs/old/ROUND_1_ARCHIVE.md (phần 06)` §4 đã đo trên 3 dataset: **số box tối ưu bám mật độ vật thể** — VOC (2,43
...
đúng thiết kế *dynamic boxes*, xem `docs/old/ROUND_1_ARCHIVE.md (phần 06)` §2.1). `EVAL_PERIOD` giữa chừng cũng chạy
