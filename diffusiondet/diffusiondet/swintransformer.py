...
import numpy as np
try:  # timm >= 0.9 chuyển timm.models.layers -> timm.layers
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        # indexing="ij" là mặc định cũ của torch.meshgrid; nêu rõ để hết warning
        # và không bị đổi hành vi ở các bản torch sau.
